...
public class Noticia
{
    ...
    public override string ToString()
    {
        ...
        return $"ID: {ID}, T�tulo: {Titulo}, Subt�tulo: {Subtitulo}, Texto: {Texto}, Data: {Data}, Ocultar: {Ocultar}, IDUsuario: {IDUsuario}, ID_ADM_Aprovou: {admAprovouInfo}, DataAprovada: {dataAprovadaInfo}";
    }
}
